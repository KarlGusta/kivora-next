...
export default function BlogPostPageClient({ post }) {
  ...
  const handleShareX = () => {
    ...
    const fullShareText = `${introductoryMessage} ${post.title} by @esimitkarlgusta`;
      ...
      <div className="pb-28 pt-32">
        ...
        <article className="mx-auto max-w-4xl px-5 md:px-8">
          <header className="mb-20">
            ...
            <h1 className="mb-10 max-w-4xl text-4xl font-semibold leading-[1.04] md:text-6xl">
              {post.title}
            </h1>
            <div className="grid gap-3 border-t border-kivora-ink/10 pt-6 text-sm font-medium text-kivora-ink/55 sm:grid-cols-3">
