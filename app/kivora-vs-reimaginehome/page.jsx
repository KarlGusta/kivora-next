...
export const metadata = {
  title: "Kivora vs REimagineHome | AI Kitchen Design Comparison 2026",
  description:
    "Kivora vs REimagineHome: compare kitchen-focused AI remodel visualization with broad photo-based home redesign. See which tool fits homeowners, designers, and remodel teams.",
  keywords:
    "kivora vs reimaginehome, reimaginehome vs kivora, kivora or reimaginehome, reimagine home comparison, ai kitchen design vs reimaginehome",
  alternates: {
    canonical: `${SITE_URL}/kivora-vs-reimaginehome`,
  },
  openGraph: {
    title: "Kivora vs REimagineHome | Kitchen Design Comparison",
    description:
      "Side-by-side comparison: kitchen-first AI remodel concepts vs broad photo-based home redesign.",
    url: `${SITE_URL}/kivora-vs-reimaginehome`,
    siteName: "Kivora",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Kivora vs REimagineHome",
    description:
      "Compare Kivora and REimagineHome — kitchen remodel visualization vs broad home redesign.",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      name: "Kivora vs REimagineHome",
      description:
        "Comparison of Kivora AI kitchen design and REimagineHome photo-based redesign for kitchen remodels.",
      url: `${SITE_URL}/kivora-vs-reimaginehome`,
      isPartOf: {
        "@type": "WebSite",
        name: "Kivora",
    ...
    },
    {
      ...
      operatingSystem: "Web",
      description:
        "Kitchen-focused AI remodel visualization compared with REimagineHome.",
      url: SITE_URL,
      offers: {
        "@type": "Offer",
        priceCurrency: "USD",
...
const matrixRows = [
  {
    ...
    competitor: "Broad photo-based home and room redesign",
    kivora: "Kitchen remodel visualization",
  },
  {
    feature: "Starting point",
    competitor: "Photo of a space + redesign options",
    kivora: "One kitchen photo + design direction",
  },
  {
    feature: "Best use case",
    competitor: "Exploring redesigns across rooms and styles",
    kivora: "Kitchen remodel decisions and sharing",
  },
  {
    feature: "Output",
    competitor: "Redesigned room images from photos",
    kivora: "Realistic kitchen remodel concepts",
  },
  {
    feature: "Audience fit",
    competitor: "Homeowners exploring general redesigns",
  ...
  },
  {
    ...
    competitor: "Broader redesign feature set",
    kivora: "Focused upload → style → generate for kitchens",
  },
  {
    feature: "Shareable output",
    competitor: "Redesign previews for inspiration",
...
const strengths = {
  competitor: [
    "Photo-based redesign across many room types",
    "Useful for general home redesign exploration",
    "Familiar AI restyle / redesign workflow",
...
const whenToChoose = [
  {
    ...
    points: [
      ...
      "You prefer a multi-room redesign suite",
    ],
  },
  {
    ...
    points: [
      ...
      "You prefer a kitchen-focused tool over a broad redesign app",
...
const verdictPoints = [
  {
    ...
    desc: "Both work from photos. REimagineHome targets broader home redesign. Kivora targets kitchen remodel visualization and decision-ready concepts.",
  },
  {
    title: "Breadth vs kitchen depth",
    desc: "If you need redesigns across the home, REimagineHome fits. If you need kitchen-specific remodel concepts you can share and act on, Kivora fits.",
  },
  {
    title: "Who wins for kitchen decisions",
    desc: "For homeowners and teams planning a kitchen remodel, a kitchen-focused tool usually reduces second-guessing faster than a general redesign product.",
  },
];

export default function KivoraVsREimagineHomePage() {
  return (
        ...
        <header className="px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-medium text-kivora-ink/45">
              ...
              <span>/</span>
              <span className="text-kivora-ink">Kivora vs REimagineHome</span>
            </nav>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-kivora-ink/70 md:text-xl">
              REimagineHome is a photo-based redesign tool for homes and rooms.
              ...
              kitchen remodel — or broader home redesign.
            </p>
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl border-y border-kivora-ink/10 py-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-kivora-ink/70">
              If REimagineHome’s broader redesign scope isn’t the right fit for
