...
export const metadata = {
  title: "Best Kitchen Design Software (2026) | AI & Planning Tools",
  description:
    "Best kitchen design software in 2026 — compare photo-based AI remodel tools, 2D/3D floor planners, and general design apps. See which fits homeowners, designers, and remodel teams.",
  keywords:
    "best kitchen design software, kitchen design software 2026, best kitchen design program, ai kitchen design software, kitchen planning software",
  alternates: {
    canonical: `${SITE_URL}/best-kitchen-design-software`,
  },
  openGraph: {
    title: "Best Kitchen Design Software | Kivora",
    description:
      "Practical guide to the best kitchen design software — photo AI, floor planners, and general design tools.",
    url: `${SITE_URL}/best-kitchen-design-software`,
    siteName: "Kivora",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Best Kitchen Design Software 2026",
    description:
      "Compare the best kitchen design software for remodel visualization and planning.",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      name: "Best Kitchen Design Software",
      description:
        "Guide to the best kitchen design software for remodel visualization and planning.",
      url: `${SITE_URL}/best-kitchen-design-software`,
      isPartOf: {
        "@type": "WebSite",
        name: "Kivora",
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "What is the best kitchen design software?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "The best kitchen design software depends on your goal. Photo-based AI tools like Kivora are strong for realistic remodel concepts from a real kitchen photo. Traditional 2D/3D planners like Planner 5D and Homestyler suit measured layouts. General room AI suits multi-room inspiration.",
          },
        },
        {
          "@type": "Question",
          name: "Do I need professional kitchen design software for a remodel?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Not always. Many homeowners start with photo-based AI for style and direction, then use a planner or work with a designer for measured plans. Match the software to the stage of your remodel.",
          },
        },
      ],
    },
...
const tools = [
  {
    name: "Kivora",
    blurb:
      "Photo-based AI kitchen design software — upload one kitchen photo and generate realistic remodel concepts for decisions and sharing.",
  ...
  },
  {
    name: "Planner 5D",
    blurb:
      "2D/3D kitchen design and floor-planning software with catalogs — strong when you need measured layouts and object placement.",
  ...
  },
  {
    name: "Homestyler",
    blurb:
      "Traditional 2D/3D kitchen design software — useful for floor plans, catalog placement, and detailed scenes.",
  ...
  },
  {
    name: "RoomGPT",
    blurb:
      "General AI room design software — fast style exploration across room types; kitchens are one of many options.",
  ...
  },
  {
    name: "REimagineHome",
    blurb:
      "Photo-based home redesign software — useful when design ideas span more than the kitchen.",
  ...
  },
  {
    name: "Remodel AI",
    blurb:
      "General remodel design software for exploring remodel looks across spaces — inspiration-first.",
...
const tips = [
  {
    title: "Software type matters",
    description:
      "Photo AI is built for “what could this look like?” Floor-planning software is built for “where does everything go to scale?” Pick for the decision you need next.",
  },
  {
    title: "Kitchen-first vs general design software",
    description:
      "General design tools are flexible. Kitchen-first software usually produces clearer cabinet, finish, and remodel direction for remodel decisions.",
  },
  {
    title: "Learning curve vs speed",
    description:
      "Traditional 3D kitchen design software can take longer to learn. Photo-based tools are often faster when you mainly need style and finish direction.",
  },
  {
    title: "You can combine tools",
    description:
      "Many people lock style with photo AI, then refine layout in planning software — or the reverse if measurements come first.",
  },
];

export default function BestKitchenDesignSoftwarePage() {
  return (
    <div className="min-h-screen bg-kivora-cream text-kivora-ink">
      ...
      <main>
        <header className="px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-medium text-kivora-ink/45">
              ...
              <span>/</span>
              <span className="text-kivora-ink">Best kitchen design software</span>
            </nav>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-kivora-ink/70 md:text-xl">
              A practical list of kitchen design software — photo-based AI, 2D/3D
              planners, and general design apps — so you can match the product to
              the stage of your remodel.
            </p>
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl">
            <h2 className="text-4xl font-semibold leading-tight md:text-5xl">
              Best kitchen design software at a glance
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-7 text-kivora-ink/70">
              Use these when comparing kitchen design software. Each card links
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl font-semibold leading-tight md:text-5xl">
                From kitchen photo to design direction in three steps
              </h2>
            </div>
        ...
        <section className="bg-white px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl border-y border-kivora-ink/10 py-16 text-center">
            ...
            <h2 className="mx-auto max-w-3xl text-4xl font-semibold leading-tight md:text-5xl">
              Ready to try photo-based kitchen design software?
            </h2>
