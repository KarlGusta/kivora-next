...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "High-intent comparison pages for Planner 5D, RoomGPT, REimagineHome, Remodel AI, HomeDesignsAI, DecorMatters, Homestyler, Interior AI, and other kitchen design tools — see why teams switch to Kivora.",
