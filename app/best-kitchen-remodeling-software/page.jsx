...
export const metadata = {
  title: "Best Kitchen Remodeling Software (2026) | AI & Planning Tools",
  description:
    "Best kitchen remodeling software in 2026 — compare photo-based AI remodel tools, 2D/3D planners, and general remodel apps. See which fits homeowners and remodel teams.",
  keywords:
    "best kitchen remodeling software, kitchen remodel software 2026, best kitchen remodel program, ai kitchen remodeling software, kitchen renovation software",
  alternates: {
    canonical: `${SITE_URL}/best-kitchen-remodeling-software`,
  },
  openGraph: {
    title: "Best Kitchen Remodeling Software | Kivora",
    description:
      "Practical guide to the best kitchen remodeling software — photo AI, floor planners, and general remodel tools.",
    url: `${SITE_URL}/best-kitchen-remodeling-software`,
    siteName: "Kivora",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Best Kitchen Remodeling Software 2026",
    description:
      "Compare the best kitchen remodeling software for visualization and planning.",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      name: "Best Kitchen Remodeling Software",
      description:
        "Guide to the best kitchen remodeling software for visualization and planning.",
      url: `${SITE_URL}/best-kitchen-remodeling-software`,
      isPartOf: {
        "@type": "WebSite",
        name: "Kivora",
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "What is the best kitchen remodeling software?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "The best kitchen remodeling software depends on your stage. Photo-based AI tools like Kivora are strong for realistic remodel concepts from a real kitchen photo. Traditional planners suit measured layouts. General remodel apps suit broader inspiration.",
          },
        },
        {
          "@type": "Question",
          name: "Can kitchen remodeling software replace a designer?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Software can accelerate direction and alignment before you hire a designer or contractor. Many teams use photo AI for style decisions, then planning software or professionals for measured construction documents.",
          },
        },
      ],
    },
...
const tools = [
  {
    name: "Kivora",
    blurb:
      "Photo-based AI kitchen remodeling software — upload one kitchen photo and generate realistic remodel concepts for decisions and sharing.",
  ...
  },
  {
    name: "Remodel AI",
    blurb:
      "General remodel software for exploring remodel looks across spaces — inspiration-first rather than kitchen-only workflows.",
  ...
  },
  {
    name: "Planner 5D",
    blurb:
      "2D/3D kitchen planning software with catalogs — strong when you need measured layouts after style is chosen.",
  ...
  },
  {
    name: "RoomGPT",
    blurb:
      "General AI room software — fast style exploration across room types; kitchens are one of many options.",
  ...
  },
  {
    name: "REimagineHome",
    blurb:
      "Photo-based home redesign software — useful when remodel ideas span more than the kitchen.",
  ...
  },
  {
    name: "HomeDesignsAI",
    blurb:
      "Broader AI home design software — useful when you want AI design across more of the home.",
...
const pickByGoal = [
  ...
  {
    title: "Measured floor plans after style is set",
...
const tips = [
  {
    title: "Match software to remodel stage",
    description:
      "Photo AI is strongest for early direction. Planning software is strongest when dimensions and placement must be exact before construction.",
  },
  {
    title: "Kitchen-first remodeling software",
    description:
      "General remodel tools are flexible. Kitchen-first software usually produces clearer cabinet, finish, and remodel direction for remodel decisions.",
  },
  {
    title: "Share before you spend",
    description:
      "Family, clients, and contractors align faster when they see concepts from the actual kitchen before big material or labor commitments.",
  },
  {
    title: "Stack tools by phase",
    description:
      "Many teams lock style with photo AI, then refine layout in planning software — or the reverse if measurements come first.",
  },
];

export default function BestKitchenRemodelingSoftwarePage() {
  return (
    <div className="min-h-screen bg-kivora-cream text-kivora-ink">
      ...
      <main>
        <header className="px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-medium text-kivora-ink/45">
              ...
              <span>/</span>
              <span className="text-kivora-ink">Best kitchen remodeling software</span>
            </nav>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] md:text-7xl">
              Best kitchen remodeling software
            </h1>
            <p className="mt-8 max-w-2xl text-lg leading-8 text-kivora-ink/70 md:text-xl">
              A practical list of kitchen remodeling software — photo-based AI,
              2D/3D planners, and general remodel apps — so you can match the
              product to the stage of your remodel.
            </p>
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl">
            <h2 className="text-4xl font-semibold leading-tight md:text-5xl">
              Best kitchen remodeling software at a glance
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-7 text-kivora-ink/70">
              Use these when comparing kitchen remodeling software. Each card
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              {[
                ...
                {
                  name: "Style",
                  desc: "Choose the remodel direction you want to explore.",
                  icon: Sparkles,
                },
                {
                  name: "Generate",
        ...
        <section className="bg-white px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl border-y border-kivora-ink/10 py-16 text-center">
            ...
            <h2 className="mx-auto max-w-3xl text-4xl font-semibold leading-tight md:text-5xl">
              Ready to try photo-based kitchen remodeling software?
            </h2>
