...
export const metadata = {
  title: "REimagineHome Alternatives | Best AI Kitchen Design Options 2026",
  description:
    "Looking for REimagineHome alternatives? Compare Kivora for kitchen-focused AI remodel visualization. Upload one kitchen photo and get realistic concepts in seconds — built for remodel decisions.",
  keywords:
    "reimaginehome alternatives, reimagine home alternatives, best reimaginehome alternatives, reimaginehome vs kivora, ai kitchen design, ai home design alternatives",
  alternates: {
    canonical: `${SITE_URL}/reimaginehome-alternatives`,
  },
  openGraph: {
    title: "REimagineHome Alternatives | Kivora",
    description:
      "Best REimagineHome alternatives for AI kitchen remodel visualization. Photo-based concepts built for kitchen decisions.",
    url: `${SITE_URL}/reimaginehome-alternatives`,
    siteName: "Kivora",
    type: "website",
  },
  twitter: {
    ...
    title: "REimagineHome Alternatives | Kivora",
    description:
      "Compare REimagineHome alternatives. Kivora focuses on realistic kitchen remodel concepts from one photo.",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      name: "REimagineHome Alternatives",
      description:
        "Best REimagineHome alternatives for AI kitchen design and remodel visualization, including Kivora.",
      url: `${SITE_URL}/reimaginehome-alternatives`,
      isPartOf: {
        "@type": "WebSite",
        name: "Kivora",
    ...
    },
    {
      ...
      operatingSystem: "Web",
      description:
        "Kitchen-focused AI design alternative to REimagineHome — realistic remodel concepts from one photo.",
      url: SITE_URL,
      offers: {
        "@type": "Offer",
        priceCurrency: "USD",
...
const reasons = [
  {
    title: "Kitchen-first remodel focus",
    desc: "REimagineHome covers interiors, exteriors, and staging across many spaces. Kivora is purpose-built for kitchen remodels — cabinets, finishes, and shareable concepts for the decisions that matter most.",
    icon: Home,
  },
  {
    title: "Decision-ready kitchen visuals",
    desc: "Get realistic kitchen concepts you can send to family, clients, or contractors — oriented around remodel direction, not only listing staging or broad home restyles.",
    icon: Target,
  },
  {
    title: "Simple photo-to-concept path",
    desc: "Upload one kitchen photo, choose a style direction, and generate polished remodel concepts in seconds — minimal setup for homeowners and designers.",
    icon: Sparkles,
  },
];
...
const comparisonRows = [
  {
    ...
    competitor: "Multi-space AI redesign (interiors, exteriors, staging)",
    kivora: "Kitchen remodel visualization",
  },
  {
    feature: "Starting point",
    competitor: "Photo of a room or exterior + style/tool selection",
    kivora: "One kitchen photo + design direction",
  },
  {
    feature: "Best use case",
    competitor: "Broad home redesign, staging, and exterior concepts",
    kivora: "Kitchen remodel decisions and sharing",
  },
  {
    feature: "Output",
    competitor: "Restyled space images across home areas",
    kivora: "Realistic kitchen remodel concepts",
  },
  {
    feature: "Audience fit",
    competitor: "Homeowners, real estate, general redesign",
    kivora: "Homeowners, designers, remodel teams",
  },
  {
    feature: "Workflow depth",
    competitor: "Multiple modes (restyle, staging, exterior, etc.)",
...
const whenToChoose = [
  {
    ...
    points: [
      "You need redesign tools across interiors, exteriors, and staging",
      "You’re optimizing listing photos or whole-home concept exploration",
      "A multi-mode AI redesign suite fits your workflow better than a kitchen-only tool",
    ],
  },
  {
    ...
    points: [
      ...
      "You prefer a kitchen-focused tool over a broad home redesign platform",
    ],
  },
];
...
export default function ReimagineHomeAlternativesPage() {
  return (
        ...
        <header className="px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-medium text-kivora-ink/45">
              ...
              <span>/</span>
              <span className="text-kivora-ink">REimagineHome Alternatives</span>
            </nav>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] md:text-7xl">
              Best REimagineHome alternatives for AI kitchen design.
            </h1>
            <p className="mt-8 max-w-2xl text-lg leading-8 text-kivora-ink/70 md:text-xl">
              REimagineHome is a strong AI tool for redesigning spaces from a
              photo across interiors and exteriors. If your goal is a kitchen
              remodel — not a broad home restyle or staging suite — Kivora is a
              focused alternative: upload one kitchen photo and get realistic
              remodel concepts built for decisions and sharing.
            </p>
            ...
            <div className="grid gap-10 border-t border-kivora-ink/10 pt-12 lg:grid-cols-[0.75fr_1.25fr]">
              <div>
                <p className="mb-4 text-sm font-medium uppercase tracking-[0.22em] text-kivora-purple">
                  Why people look for REimagineHome alternatives
                </p>
                <h2 className="max-w-md text-4xl font-semibold leading-tight md:text-5xl">
                  Broad redesign suite vs kitchen remodel focus.
                </h2>
              </div>
              <p className="max-w-2xl text-lg leading-8 text-kivora-ink/70">
                REimagineHome works well when you need multiple modes across the
                home. Users often search for alternatives when the project is a
                kitchen remodel, they want a simpler kitchen-first path, or they
                need concepts oriented around remodel decisions rather than
                general restyling or listing staging.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl font-semibold leading-tight md:text-5xl">
                REimagineHome vs Kivora at a glance
              </h2>
            </div>
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl border-y border-kivora-ink/10 py-16 text-center">
            ...
            <h2 className="mx-auto max-w-3xl text-4xl font-semibold leading-tight md:text-5xl">
              Ready for a REimagineHome alternative built for kitchens?
            </h2>
