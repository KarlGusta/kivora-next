...
export const metadata = {
  title: "Best Kitchen Planner (2026) | AI & Layout Tools Compared",
  description:
    "Best kitchen planner tools in 2026 — compare photo-based AI remodel tools, 2D/3D floor planners, and general design apps. See which fits layout planning and remodel decisions.",
  keywords:
    "best kitchen planner, kitchen planner online, best kitchen floor planner, ai kitchen planner 2026, kitchen layout planner",
  alternates: {
    canonical: `${SITE_URL}/best-kitchen-planner`,
  },
  openGraph: {
    title: "Best Kitchen Planner | Kivora",
    description:
      "Practical guide to the best kitchen planner tools — photo AI, floor planners, and general design apps.",
    url: `${SITE_URL}/best-kitchen-planner`,
    siteName: "Kivora",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Best Kitchen Planner 2026",
    description:
      "Compare the best kitchen planner tools for layout and remodel decisions.",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      name: "Best Kitchen Planner",
      description:
        "Guide to the best kitchen planner tools for layout planning and remodel visualization.",
      url: `${SITE_URL}/best-kitchen-planner`,
      isPartOf: {
        "@type": "WebSite",
        name: "Kivora",
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "What is the best kitchen planner?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "The best kitchen planner depends on your goal. Traditional 2D/3D planners like Planner 5D and Homestyler are strong for measured layouts. Photo-based AI tools like Kivora are strong when you need realistic remodel concepts from your real kitchen before or alongside layout work.",
          },
        },
        {
          "@type": "Question",
          name: "Do I need measurements to use a kitchen planner?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Floor-planning tools work best with room dimensions. Photo-based AI planners can start from a kitchen photo for style and finish direction without exact measurements first.",
          },
        },
      ],
    },
...
const tools = [
  {
    name: "Kivora",
    blurb:
      "Photo-based AI kitchen planner alternative — upload one kitchen photo and generate realistic remodel concepts for decisions and sharing.",
    bestFor: "Remodel direction from a real kitchen photo",
    href: "/",
    cta: "Try Kivora",
  },
  {
    name: "Planner 5D",
    blurb:
      "2D/3D kitchen floor planner with catalogs — strong when you need measured layouts and object placement from a blank slate or plan.",
    bestFor: "Measured layout planning and catalog placement",
  ...
  },
  {
    name: "Homestyler",
    blurb:
      "Traditional 2D/3D kitchen planner — useful for floor plans, catalog placement, and detailed layout scenes.",
    bestFor: "Measured plans and 3D layout scenes",
  ...
  },
  {
    name: "RoomGPT",
    blurb:
      "General AI room design tool — fast style exploration across room types; not a measured floor planner.",
    bestFor: "Multi-room style inspiration",
  ...
  },
  {
    name: "REimagineHome",
    blurb:
      "Photo-based home redesign tool — useful when planning ideas span more than the kitchen.",
  ...
  },
  {
    name: "Remodel AI",
    blurb:
      "General remodel tool for exploring remodel looks — inspiration-first rather than measured planning.",
  ...
  },
  {
    name: "HomeDesignsAI",
    blurb:
      "Broader AI home design tool — useful when you want AI design across more of the home.",
...
const pickByGoal = [
  {
    title: "Measured floor plan and layout accuracy",
    pick: "Planner 5D or Homestyler",
  },
  {
    title: "Remodel concepts from my kitchen photo",
    pick: "Kivora",
  },
  {
...
const tips = [
  {
    title: "Planner vs visualizer",
    description:
      "Floor planners optimize for dimensions and placement. Photo AI optimizes for realistic “what could this look like?” — many people use both.",
  },
  {
    title: "Measurements first or style first",
    description:
      "If walls and work triangle must be exact, start with a planner. If you need style and finish direction first, start with a photo-based tool.",
  },
  {
    title: "Kitchen-first still helps",
    description:
      "Even when planning layout, kitchen-focused tools tend to produce clearer cabinet and remodel direction than generic room tools alone.",
  },
  {
    title: "Share the plan early",
    description:
      "Family, clients, and contractors align faster when they see both a layout direction and realistic visuals from the actual space.",
  },
];

export default function BestKitchenPlannerPage() {
  return (
    <div className="min-h-screen bg-kivora-cream text-kivora-ink">
      ...
      <main>
        <header className="px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm font-medium text-kivora-ink/45">
              ...
              <span>/</span>
              <span className="text-kivora-ink">Best kitchen planner</span>
            </nav>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] md:text-7xl">
              Best kitchen planner
            </h1>
            <p className="mt-8 max-w-2xl text-lg leading-8 text-kivora-ink/70 md:text-xl">
              A practical list of kitchen planner tools — measured 2D/3D floor
              planners, photo-based AI, and general design apps — so you can match
              the product to layout vs style decisions.
            </p>
        ...
        <section className="px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl">
            <h2 className="text-4xl font-semibold leading-tight md:text-5xl">
              Best kitchen planners at a glance
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-7 text-kivora-ink/70">
              Use these when comparing kitchen planner options. Each card links
        ...
        <section className="bg-white px-5 py-20 md:px-8">
          <div className="mx-auto max-w-7xl border-y border-kivora-ink/10 py-16 text-center">
            ...
            <h2 className="mx-auto max-w-3xl text-4xl font-semibold leading-tight md:text-5xl">
              Need style direction before you plan the layout?
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-kivora-ink/70">
              ...
              seconds — then refine layout in a measured planner if you need it.
            </p>
